...
Note that this method does not incorporate grouping, so users the arguments `group` and `groupByTime` should set as default,  that is `None' and `FLASE' correspondingly.
