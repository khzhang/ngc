...
```{r pressure, echo=FALSE, cache=TRUE, eval=TRUE}
...
# fit32 <-ngc(X, d=2,method = 'truncate', typeIerr = 0.02, group = group, groupByTime = TRUE)
# fit32$tsOrder
# microbenchmark(ngc(X, d=2,method = 'truncate', typeIerr = 0.02, group = group, groupByTime = TRUE),
#                times = 10)
# 
# checkEstimation(phi_true, fit32$estMat[,,1:d], method_name = "Truncate Lasso")$metrics
...
# 
# fit342 <-ngc(X_grp, method = 'truncate', typeIerr = 0.02, group = group)
# fit342$tsOrder
# microbenchmark(ngc(X_grp, method = 'truncate', typeIerr = 0.02, group = group), 
#                times = 10)
# 
# checkEstimation(phi_true_grp, fit342$estMat[,,1:d], method_name = "Truncate Lasso")$metrics
# 
# fit343 <-ngc(X_grp, method = 'truncate', typeIerr = 0.02, group = group, groupByTime = TRUE)
# fit343$tsOrder
# microbenchmark(ngc(X_grp, method = 'truncate', typeIerr = 0.02, group = group, groupByTime = TRUE), 
#                times = 10)
# 
# checkEstimation(phi_true_grp, fit343$estMat[,,1:d], method_name = "Truncate Lasso")$metrics
